...
impl NeuronIndex {
    ...
    fn synthetic_answer_path(&self, task: &str) -> Option<PathBuf> {
        let task_lower = task.to_ascii_lowercase();
    ...
    pub(super) fn matching_verbatim_texts(
        &self,
        required_terms: &[&str],
        limit: usize,
    ) -> Vec<(PathBuf, String)> {
    ...
    pub(super) fn find_matching_lines<F>(
        &self,
        required_terms: &[&str],
        limit: usize,
        summary_only: bool,
    ...
    fn max_count_from_matching_texts<F>(
        &self,
        required_terms: &[&str],
        limit: usize,
        mut parser: F,
    ...
    fn max_count_answer_from_matching_texts<F>(
        &self,
        task: &str,
        required_terms: &[&str],
        limit: usize,
    ...
    fn synthetic_missing_operand_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
    ...
    fn synthetic_doctor_visit_count_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
    ...
    fn synthetic_unit_price_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
        if !is_money_query(task)
    ...
    fn synthetic_multi_session_money_total_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_multi_session_duration_total_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_formal_education_total_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_education_milestone_interval_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_current_role_duration_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_direct_count_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
        if !detect_counting_query(task)
    ...
    fn synthetic_study_subject_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_instagram_current_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_collection_window_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_daily_time_commitment_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_time_spent_range_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
        if !detect_counting_query(task)
            || is_money_query(task)
    ...
    fn synthetic_publication_issue_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_collection_restart_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_weight_loss_since_start_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_since_start_count_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
        if !detect_counting_query(task)
            || (!task_lower.contains("since starting ") && !task_lower.contains("since i started "))
            || task_lower.contains("collecting again")
            || task_contains_any(
    ...
    fn synthetic_temporal_choice_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
    ...
    fn synthetic_temporal_elapsed_duration_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_temporal_from_now_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
    ...
    fn best_temporal_current_anchor_session(&self, session_id: &str) -> Option<(i32, String)> {
    ...
    fn verbatim_entry_groups_for_session(&self, session_id: &str) -> Vec<Vec<&BM25Entry>> {
    ...
    fn read_matching_session_group_lines<F>(
        &self,
        entries: &[&BM25Entry],
        mut predicate: F,
    ) -> Vec<String>
    ...
    fn temporal_from_now_event_candidates(
        &self,
        phrase_lower: &str,
        terms: &[String],
    ...
    fn synthetic_title_duration_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
    ...
    fn synthetic_temporal_interval_between_events_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_item_usage_frequency_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_media_rewatch_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_family_origin_item_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_recent_birth_count_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
        if !detect_counting_query(task)
    ...
    fn synthetic_bike_service_count_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
        if !detect_counting_query(task)
    ...
    fn synthetic_fitness_class_day_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_month_scoped_activity_day_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_art_related_event_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_distinct_cuisine_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_museum_gallery_visit_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_citrus_fruit_count_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
    ...
    fn synthetic_food_delivery_service_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_missed_fun_run_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_graduation_ceremony_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_health_device_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_peak_campaign_weekly_hours_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_recent_activity_duration_total_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_current_magazine_subscription_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_marathon_target_overrun_minutes_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_movie_festival_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_music_release_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_current_musical_instrument_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_online_course_completion_total_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_recent_furniture_action_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_initial_garden_planting_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_sephora_points_needed_for_free_skincare_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_pre_offer_property_view_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_role_transition_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_activity_frequency_transition_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_named_recurring_frequency_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_named_current_company_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_named_artwork_location_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_current_schedule_slot_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_state_transition_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
    ...
    fn synthetic_previous_purchased_item_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_latest_purchased_lens_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_planned_trip_stay_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
        if !task_lower.starts_with("where ")
    ...
    fn synthetic_previous_named_tutor_weekday_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_named_meetup_count_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
        if !detect_counting_query(task)
            || !task_contains_any(
                task_lower,
    ...
    fn synthetic_named_team_composition_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_hilton_free_night_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_poster_university_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
        if !task_contains_any(
            task_lower,
            &[
                "at which university",
    ...
    fn synthetic_missing_institution_activity_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_missing_named_anchor_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_knowledge_update_yes_no_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_knowledge_update_delta_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_transport_cost_delta_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_named_schedule_rotation_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_restaurant_serving_dish_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_bike_inventory_before_purchase_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_commute_time_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
    ...
    fn synthetic_coupon_store_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
    ...
    fn synthetic_image_subject_color_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_issue_after_service_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn synthetic_fitness_record_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
    ...
    fn synthetic_project_lead_count_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
        if !detect_counting_query(task)
    ...
    fn synthetic_model_kit_count_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
    ...
    fn synthetic_clothing_store_count_answer(
        &self,
        task: &str,
        task_lower: &str,
    ) -> Option<PathBuf> {
    ...
    fn best_matching_session_id(&self, task: &str, required_terms: &[&str]) -> Option<String> {
        self.candidate_session_ids(task, required_terms, 1)
            .into_iter()
            .next()
    }

    pub(super) fn candidate_session_ids(
        &self,
        task: &str,
        required_terms: &[&str],
        limit: usize,
    ...
    pub(super) fn find_session_lines<F>(
        &self,
        session_id: &str,
        summary_only: bool,
        max_lines: usize,
    ...
    pub(super) fn candidate_session_ids_by_line_overlap(
        &self,
    ...
    pub(super) fn ranked_numeric_aggregate_sessions<F>(
        &self,
        task: &str,
        focus_terms: &[String],
        mut predicate: F,
    ...
    pub(super) fn session_answer_candidate_lines(
        &self,
        session_id: &str,
        limit: usize,
    ) -> Vec<(String, bool)> {
    ...
    pub(super) fn session_verbatim_answer_candidate_lines(
        &self,
        session_id: &str,
        limit: usize,
    ) -> Vec<String> {
    ...
    pub(super) fn find_session_assistant_lines<F>(
        &self,
        session_id: &str,
        max_lines: usize,
        mut predicate: F,
    ...
    fn best_session_line_projection_answer(
        &self,
        task: &str,
        task_lower: &str,
    ...
    fn synthetic_session_personal_fact_answer(
        &self,
        task: &str,
        task_lower: &str,
        predicate: &str,
    ...
    fn synthetic_assistant_followup_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
    ...
    fn synthetic_session_recall_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
    ...
    fn synthetic_numbered_list_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
    ...
    pub(super) fn session_ids_matching_line<F>(&self, mut predicate: F) -> Vec<String>
    where
        F: FnMut(&str, &str) -> bool,
    {
        let mut session_ids = Vec::new();
    ...
    fn synthetic_pet_name_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
    ...
    fn synthetic_answer_surface_answer(&self, task: &str, task_lower: &str) -> Option<PathBuf> {
        let task_terms = synthetic_query_terms(task_lower);
        if task_terms.len() < 2 {
            return None;
        }
    ...
    fn synthetic_answer_surface_is_list_query(task_lower: &str) -> bool {
    ...
    fn synthetic_answer_surface_target_items(task_lower: &str) -> usize {
    ...
    fn compose_index_answer_surface_answer(
        task_lower: &str,
    ...
    fn index_answer_surface_composition_rank(bucket: &IndexAnswerSurfaceBucket) -> f32 {
        bucket.best_score
            + bucket.max_overlap as f32 * 2.0
            + (bucket.paths.len().saturating_sub(1) as f32) * 1.5
    }

    fn is_composeable_index_answer_surface_bucket(bucket: &IndexAnswerSurfaceBucket) -> bool {
    ...
    fn split_index_answer_surface_items(text: &str) -> Vec<String> {
        let clean = text
            .trim()
            .replace(", and ", ", ")
            .replace(" and ", ", ")
    ...
    fn format_index_answer_surface_list(items: &[String]) -> String {
        match items {
            [] => String::new(),
            [item] => item.clone(),
    ...
    fn synthetic_kg_personal_fact_answer(&self, task: &str) -> Option<PathBuf> {
...
pub use self::helpers::{dirty_path, infer_module, is_capsule_module, module_capsule_path, tokenize};
#[cfg(test)]
